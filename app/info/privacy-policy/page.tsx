				...
				<Box p={3}>
					...
					<List>
						...
						<ListItem>
							<ListItemText
								primary="Affiliate"
								secondary="An entity that controls, is controlled by or is under common control with a party, where 'control' means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority."
							/>
						</ListItem>
						<ListItem>
							<ListItemText
								primary="Company"
								secondary="Referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement) refers to Vine and Frond, Hendersonville, NC."
							/>
						</ListItem>
						<ListItem>
							<ListItemText
								primary="Cookies"
								secondary="Small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses."
							/>
						</ListItem>
						<ListItem>
							<ListItemText
								primary="Country"
								secondary="North Carolina, United States"
							/>
						</ListItem>
						<ListItem>
							<ListItemText
						...
						<ListItem>
							<ListItemText
								primary="Usage Data"
								secondary="Data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit)."
							/>
						</ListItem>
						<ListItem>
							<ListItemText
						...
						<ListItem>
							<ListItemText
								primary="You"
								secondary="The individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable."
							/>
						</ListItem>
					</List>
					<Typography variant="h6" component="h2">
					...
					<List>
						<ListItem>
							<ListItemText primary="By email: vineandfrond@gmail.com" />
						</ListItem>
					</List>
				</Box>
			</FullWidthCard>
